                          ...
                          ptl_size_t threshold)
{
    ...
    printf("ct:           offset: %lu length: %lu\n", offsetof(buf_t, ct), sizeof(buf->ct));
    printf("type:         offset: %lu length: %lu\n", offsetof(buf_t, type), sizeof(buf->type));
    printf("me_op:        offset: %lu length: %lu\n", offsetof(buf_t, me_op), sizeof(buf->me_op));
    printf("pt_index:     offset: %lu length: %lu\n", offsetof(buf_t, pt_index), sizeof(buf->pt_index));
    printf("me_init:      offset: %lu length: %lu\n", offsetof(buf_t, me_init), sizeof(buf->me_init));
    printf("ptl_list:     offset: %lu length: %lu\n", offsetof(buf_t, ptl_list), sizeof(buf->ptl_list));
    printf("me_handle_p:  offset: %lu length: %lu\n", offsetof(buf_t, me_handle_p), sizeof(buf->me_handle_p));
    printf("ni_handle:    offset: %lu length: %lu\n", offsetof(buf_t, ni_handle), sizeof(buf->ni_handle));
#endif
...
void do_trig_me_op(buf_t *buf, ct_t *ct)
{
    ...
    switch (buf->me_op) {
        case TRIG_ME_APPEND:
            //printf("doing triggered op %p %lu %lx\n", buf->me_init->start, buf->me_init->length, buf->me_init->match_bits);
...
static void post_trig_me(buf_t *buf, ct_t *me_ct)
{
    ...
    //printf(" f: %lu s: %lu th: %lu\n", me_ct->info.event.failure, me_ct->info.event.success, buf->ct_threshold);
