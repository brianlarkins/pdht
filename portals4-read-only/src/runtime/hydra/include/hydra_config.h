...
#define HYDRA_AVAILABLE_TOPOLIBS ""

/* C compiler */
#define HYDRA_CC "gcc     "

/* Configure arguments */
#define HYDRA_CONFIGURE_ARGS_CLEAN "'--disable-option-checking' '--prefix=/opt/hpctools' '--enable-transport-ib' '--enable-zeromrs' '--enable-me-triggered' '--cache-file=/dev/null' '--srcdir=.'"
