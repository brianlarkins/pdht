  ...
  task_handle_t refine_project_handle;
  task_handle_t compress_handle;
  task_handle_t reconstruct_handle;
  task_handle_t diff_handle;
 ...
 */
void fine_scale_project(funct_t *f, madkey_t *nkey) {
...
void refine_fine_scale_project(func_t *f, madkey_t *nkey) {
  ...
  int main(int argc, char **argv, char **envp) {
    ...
    f = init_function(k, threshold, test, INITIAL_LEVEL);
