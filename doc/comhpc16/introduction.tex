...
The message matching model used by the Message Passing Interface
...
%pairs of matched sends and receives. Portals also provides a {\em
%  non-matching interface} that foregoes the complexity of a matched
%two-sided communications system in favor of a lightweight, efficient
