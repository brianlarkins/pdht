...
plot 'comet.scaling.dat' index 1 using 1:($1*10000)/(($2/1000)*1000000) title "MVAPICH2" lw 2, \
     'comet.scaling.dat' index 1 using 1:($1*10000)/(($4/1000)*1000000) title "PDHT" lw 2
